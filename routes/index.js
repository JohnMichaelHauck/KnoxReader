...
function convertBook(fileText) {
  ...
  encode(/§1·(15·2|16·1|22·1|24·1:|28·1|29|30|36)\D/, /Prince|King/g, classes, false);
  ...
  encode(/§1·(25|26|31|36)\D/, /Cardinal|Beaton/g, classes, false);
  ...
  encode(/§/, /Oliver Sinclair/g, classes);
